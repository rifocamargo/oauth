...
public class InsertJobRunnerAndServiceOAuthClientDetails implements CustomSqlChange {
	private static final Logger LOGGER = LoggerFactory.getLogger(InsertJobRunnerAndServiceOAuthClientDetails.class);

	private static final String SECRET = "900c8450-02fc-46de-8319-d5423e6e628a";
	...
	public SqlStatement[] generateStatements(Database database) throws CustomChangeException {
		return new SqlStatement[] { this.createClient("job-service", "job-service", "8084"),
									this.createClient("job-runner", "job-runner", "8085")};
	}
